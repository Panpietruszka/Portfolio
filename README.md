...
Główne sekcje strony:
    ...
    O mnie: Krótka historia mojej drogi w programowaniu i cele zawodowe.

    Stack Technologiczny: Wykaz języków, frameworków i narzędzi, których używam na co dzień.
...
Projekt został zbudowany przy użyciu następujących technologii:
    ...
    Styling: [np. Tailwind CSS / Styled Components / SASS]

    Deployment: [np. Vercel / Netlify / GitHub Pages]
...
W sekcji projektów znajdują się m.in.:
    ...
    [Nazwa Projektu 1] – [Krótki opis, np. Aplikacja do zarządzania zadaniami].

        Tech stack: React, Firebase.

        [Link do Demo] | [Link do Kodu]

    [Nazwa Projektu 2] – [np. E-commerce dashboard].
